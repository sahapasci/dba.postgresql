...
BEGIN
  SELECT
      psa_bed.procpid AS blocked_pid,
      ...
      psa_bed.current_query::VARCHAR AS blocked_query,
      ...
      psa_bing.procpid AS blocking_pid,
      ...
      psa_bing.current_query::VARCHAR AS blocking_query,
    ...
    JOIN pg_catalog.pg_stat_activity psa_bed ON l_bed.pid = psa_bed.procpid
    ...
    JOIN pg_catalog.pg_stat_activity psa_bing ON l_bing.pid = psa_bing.procpid
    WHERE 
